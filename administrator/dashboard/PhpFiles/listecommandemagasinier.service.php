...
if(isset($_POST["load"]))
{
  $req1=$mysqli->query("select * from listecommande l join client c on c.idClient=l.idClient where l.validerAdmin='1' group by l.idlistecom  order by l.statut ");
  $products=[];
...
if(isset($_POST["validateCommande"]))
{
  ...
  $req1=$mysqli->query("update listecommande set statut='1', emailAdmin='$admin' , dateValidate='$date' ,prixtotal='$pointe' where idlistecom='$id'") or die(mysqli_error());
