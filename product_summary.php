...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <body>
        ...
        <div class="row">
          <div class="span12">
            <ul class="breadcrumb">
              ...
              <li class="active languageShoppongCart">SHOPPING CART</li>
            </ul>
            <h3>
              <span class="languageShoppongCart"> SHOPPING CART </span> [
              <small><span id="count"></span> Item(s) </small>]<a
                href="index.php"
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Description</th>
                  <th class="languageQuantityUpdate">Quantity/Update</th>
                  <th class="languageprice">Price (Dh)</th>
                  <th>Total (Dh)</th>
                </tr>
              </thead>
              <tbody class="product">
    ...
    <script defer src="javascript/product_summary.js"></script>
  </body>
</html>
